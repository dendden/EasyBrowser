...
//  EasyBrowser
//
//  Created by Денис Трясунов on 11/17/16.
...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let browserVC = storyboard?.instantiateViewController(withIdentifier: "Browser") as? ViewController {
            browserVC.siteToShow = TableViewController.websites[indexPath.row]
